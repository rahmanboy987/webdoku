...
window.onload = function() {
    ...
    for (let i = 0; i < id("number").children.length; i++) {
        id("number").children[i].addEventListener("click", function() {
            if(!disableSelect) {
                if(this.classList.contains("selected")) {
                    ...
                    for(let i = 0; i<9; i++) {
                        id("number").children[i].classList.remove("selected");
                    }
...
function startGame(){
    ...
    id("number").classList.remove("hidden");
}
